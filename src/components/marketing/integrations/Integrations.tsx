      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-6">
        <Card className="col-span-2">
          <div className="rounded-lg bg-gradient-to-br from-blue-600/20 via-transparent to-transparent">
            <CardHeader>
              <NextAuthLogo variant="symbol" className="self-start mb-2 h-14" />
        ...
        <Card className="col-span-2">
          <div className="rounded-lg bg-gradient-to-br from-blue-600/20 via-transparent to-transparent">
            <CardHeader>
              <TailwindLogo variant="symbol" className="self-start mb-2 h-14" />
              <CardTitle className="text-white text-md">
                Beautifully themed
              </CardTitle>
            </CardHeader>
            ...
            <CardFooter>
              <TailwindLogo variant="color" className="self-start text-white" />
            </CardFooter>
          </div>
        </Card>
